            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {filteredMeals.map(meal => (
                <button
                  ...
                  className="text-left p-4 border border-gray-200 dark:border-gray-700 dark:bg-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 transition-all"
                >
