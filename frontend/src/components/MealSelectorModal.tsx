      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-3xl w-full max-h-[80vh] flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold dark:text-white">Select Meal for {dayName}</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <select
              ...
              className="w-full sm:w-auto px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {filteredMeals.map(meal => (
                <button
                  ...
                  className="text-left p-4 border border-gray-200 dark:border-gray-700 dark:bg-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-600 transition-all"
                >
                  <div className="font-semibold text-lg mb-2 dark:text-white">{meal.name}</div>
