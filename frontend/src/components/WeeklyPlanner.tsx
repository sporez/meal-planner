...
export default function WeeklyPlanner({ onPlanSaved, editingPlan }: WeeklyPlannerProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Read algorithm settings from localStorage
      const settingsJson = localStorage.getItem('algorithmSettings');
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={isGenerating || isSaving}
                className="px-3 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700 disabled:bg-blue-300 transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-3">
            {DAYS_OF_WEEK.map((day, index) => {
              ...
              return (
                <div
                  key={day}
                  className="meal-day border border-gray-200 dark:border-gray-700 dark:bg-gray-700 rounded-lg p-3 hover:shadow-md transition-shadow"
                >
                    ...
                    <div>
                      ...
                      <div className="flex gap-1">
                        <button
                          ...
                          disabled={isSaving}
                          className="flex-1 px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-200 rounded hover:bg-blue-200 dark:hover:bg-blue-800 disabled:opacity-50 transition-colors"
                        >
                          Swap
                        </button>
                        <button
                          ...
                          disabled={isSaving}
                          className="flex-1 px-2 py-1 text-xs bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-200 rounded hover:bg-green-200 dark:hover:bg-green-800 disabled:opacity-50 transition-colors"
                        >
                          Choose
                        </button>
                      </div>
